...
values:
  ...
  - heading: "First Contact and the Ambassador "
    text: First contact personally with the High Minister of Jovia as well two High
      Council Members of Saturn. The three are always with me as observers for
      over a decade through the wars of Armageddon to the present
  ...
  - heading: "875 Universe Life Challenges Complete "
    text: Navigation of all life out six universe collapses
    imageUrl: img/GHXWRBCZYVLYX4SQDALABE4D.jpeg
  - heading: "Mortal combat champion of the Archangel Gabriel "
    text: "Champion of six universe rings of Mortal Combat holding the one and only
      White Dragon Belt of the Universe in the battle for mankind's freewill
      between Satan Micheal and Gabriel in Final Conflict Final judgement and
      end of days for mankind "
    imageUrl: img/screenshot.23-1.jpg
  - heading: Citizen of Jupiter and Saturn
    text: Achievement of Saturnian Medical doctor and Jovian advanced
      electromagnetism by the eye of Jupiter in the elements of electricity and
      command of them
    imageUrl: img/pia16695_large.jpg
  - heading: Captain of 3601 spaceships and hold title to them
